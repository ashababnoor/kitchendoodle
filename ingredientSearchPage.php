...
$_SESSION['current_page'] = 'ingredientSearchPage.php';
...
if(
    ...
    <head>
        ...
        <title>Search For Ingredients | KitchenDoodle</title>
        <style>
    ...
    <body>
            ...
            <div class="d-flex align-items-center justify-content-center search-box-container">
                <div>
                    ...
                    <div class="d-flex justify-content-center p-1">
                        ...
                        <input type="button" class="btn" id="recipeAllButton" value="Show All" onclick="redirect('allIngredients.php')">
                    </div>
                </div>
            </div>
        </div>
        ...
        <script>
            function searchResult(){
                ...
                location.assign('ingredientSearchResult.php?text=' + string);
            }
        </script>
