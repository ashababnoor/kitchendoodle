...
$_SESSION['current_page'] = 'recipeSearchResult.php?text='.$_GET['text'];
...
if(
    ...
    <head>
        ...
        <title>Recipe Search Result | KitchenDoodle</title>
        <style>
            small{
                color: #888;
            }
            ...
            <div class="column-container">
                ...
                <div>
                    ...
                    try{
                        ...
                        $querystring = "SELECT * FROM recipes WHERE name LIKE '%$string%' AND total_price > 0";
