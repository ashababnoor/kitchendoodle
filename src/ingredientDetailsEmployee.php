...
$_SESSION['current_page'] = 'ingredientDetailsEmployee.php?id=';
                ...
                <div class="row" id="content-row">
                    ...
                    <div class="col-lg-6 col-12">
                        ...
                        <div class="" id="action-row">
                            <input type="button" class="btn btn-sm btn-primary" value="Update Attributes" onclick="redirect('ingredientAttribute.php?id='+<?php echo $id ?>)">
                            <input type="button" class="btn btn-sm btn-primary" value="Update Info" onclick="recipeUpdate(<?php echo $id ?>)">
                            <input type="button" class="btn btn-sm btn-primary" value="Delete Ingredient" onclick="deletefn(<?php echo $id ?>, 'ingredients');">
                            <input type="button" class="btn btn-sm btn-primary" value="All Ingredients" onclick="redirect('ingredientsList.php')">
                        </div>
